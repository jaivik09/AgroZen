                                ...
                                <tbody>
                                    <?php
                                        while ($row1 = mysqli_fetch_assoc($result1)) {
                                            echo "<tr>";
                                            echo "<input type='hidden' id='farmer_name_$row1[prod_id]' value='$row1[farmer_name]'>";
                                            ...
                                            echo "<a class='bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white' target='_blank' href='../uploads/farmer upload/" . $row1['main_img'] . "'><i class='fas fa-eye'></i></a>";
                                            echo "<a class='bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white' onclick='openPopup($row1[prod_id])'><i class='fas fa-comment'></i></a>";
                                            echo "</td>";
                                            echo "<td class='border px-4 py-2'>";
                                            ...
                                            echo "<form class='px-8 pb-6' method='post' action=''>";
                                            echo "<input type='hidden' id='farmer_name' name='farmer_name' value='$row1[farmer_name]'>";
                                            echo "<label for='feedback' class='block mb-2 text-gray-700'>Feedback:</label>";
                                            echo "<textarea id='feedback' name='feedback' rows='4' class='w-full p-2 border border-gray-300 rounded mb-4 focus:outline-none focus:ring focus:border-blue-500' required></textarea>";
                                            echo "<button class='bg-blue-700 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring focus:border-blue-500' name='send' value='send' type='send'>Send</button>";
                                            echo "</form>";
                                            echo "</div>";
                                        }
                                    ?>
...
<?php
    ...
    if (isset($_POST['send'])) {
        ...
        $farmer_name = isset($_POST['farmer_name']) ? $_POST['farmer_name'] : '';
